...
var Fe = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
  ...
  ma = (e, t, r, n) => {
    if ((t && typeof t == 'object') || typeof t == 'function')
      for (const i of ua(t))
        !pa.call(e, i) && i !== r && en(e, i, { get: () => t[i], enumerable: !(n = la(t, i)) || n.enumerable })
    return e
  }
var Qe = (e, t, r) => (
  (r = e != null ? aa(ca(e)) : {}), ma(t || !e || !e.__esModule ? en(r, 'default', { value: e, enumerable: !0 }) : r, e)
)
var y,
  u = me(() => {
    y = {
...
var Ei = Fe((Ke) => {
    ...
    da = oi((e) => {
      ...
      function g(A) {
        ...
        for (G = 0; G < ie; G += 4)
          (R =
            ...
            (k[F++] = R & 255)
        return (
          B === 2 && ((R = (r[A.charCodeAt(G)] << 2) | (r[A.charCodeAt(G + 1)] >> 4)), (k[F++] = R & 255)),
          B === 1 &&
            ((R = (r[A.charCodeAt(G)] << 10) | (r[A.charCodeAt(G + 1)] << 4) | (r[A.charCodeAt(G + 2)] >> 2)),
            (k[F++] = (R >> 8) & 255),
            (k[F++] = R & 255)),
          k
        )
      ...
      function v(A, R, D) {
        for (var M, B = [], k = R; k < D; k += 3)
          (M = ((A[k] << 16) & 16711680) + ((A[k + 1] << 8) & 65280) + (A[k + 2] & 255)), B.push(h(M))
        return B.join('')
      }
      function S(A) {
        ...
        return (
          M === 1
            ...
            : M === 2 &&
              ((R = (A[D - 2] << 8) + A[D - 1]), B.push(t[R >> 10] + t[(R >> 4) & 63] + t[(R << 2) & 63] + '=')),
          B.join('')
        )
      }
    }),
    fa = oi((e) => {
      ;(e.read = (t, r, n, i, o) => {
        ...
        if (s === 0) s = 1 - g
          ...
          if (s === f) return a ? Number.NaN : (A ? -1 : 1) * (1 / 0)
  ...
  function si(e, t, r) {
    ...
    if (
      ...
      (typeof SharedArrayBuffer < 'u' && (de(e, SharedArrayBuffer) || (e && de(e.buffer, SharedArrayBuffer))))
    )
      return li(e, t, r)
    if (typeof e == 'number')
  ...
  function ha(e, t, r) {
    return ai(e), e <= 0 ? be(e) : t !== void 0 ? (typeof r == 'string' ? be(e).fill(t, r) : be(e).fill(t)) : be(e)
  }
  ...
  function rn(e) {
    const t = e.length < 0 ? 0 : sn(e.length) | 0,
      r = be(t)
  ...
  T.prototype.toString = function () {
    const e = this.length
    return e === 0 ? '' : arguments.length === 0 ? pi(this, 0, e) : xa.apply(this, arguments)
  }
  ...
  function ci(e, t, r, n, i) {
    ...
    if ((typeof t == 'string' && (t = T.from(t, n)), T.isBuffer(t))) return t.length === 0 ? -1 : ri(e, t, r, n, i)
    if (typeof t == 'number')
      return (
        (t = t & 255),
        ...
        switch (a) {
          ...
          case 3:
            ;(l = e[i + 1]),
              ...
              (l & 192) === 128 &&
                (f & 192) === 128 &&
                ((h = ((o & 15) << 12) | ((l & 63) << 6) | (f & 63)), h > 2047 && (h < 55296 || h > 57343) && (s = h))
            break
          case 4:
            ;(l = e[i + 1]),
              (f = e[i + 2]),
  ...
  function Sa(e) {
    ...
    let r = '',
      n = 0
    while (n < t) r += String.fromCharCode.apply(String, e.slice(n, (n += ni)))
    return r
  }
  function ka(e, t, r) {
    let n = ''
  ...
  T.prototype.writeUint16LE = T.prototype.writeUInt16LE = function (e, t, r) {
    return (
      (e = +e), (t = t >>> 0), r || te(this, e, t, 2, 65535, 0), (this[t] = e & 255), (this[t + 1] = e >>> 8), t + 2
    )
  }
  T.prototype.writeUint16BE = T.prototype.writeUInt16BE = function (e, t, r) {
    return (
      (e = +e), (t = t >>> 0), r || te(this, e, t, 2, 65535, 0), (this[t] = e >>> 8), (this[t + 1] = e & 255), t + 2
    )
  }
  ...
  T.prototype.writeInt8 = function (e, t, r) {
    return (
      (e = +e), (t = t >>> 0), r || te(this, e, t, 1, 127, -128), e < 0 && (e = 255 + e + 1), (this[t] = e & 255), t + 1
    )
  }
...
var Vi,
  ...
  Gi = me(() => {
    ...
    ;(Vi = '/'),
      (ll = { sep: Vi }),
      (ul = { basename: $i, dirname: ji, join: sl, parse: al, posix: ll, resolve: ol, sep: Vi }),
      (cr = ul)
  })
var Qi = Fe((sd, cl) => {
  cl.exports = {
...
function j(e, t) {
  const r = new RegExp(`\\x1b\\[${t}m`, 'g'),
    n = `\x1B[${e}m`,
    i = `\x1B[${t}m`
  return (o) => (!qa.enabled || o == null ? o : n + (~('' + o).indexOf(i) ? o.replace(r, i + n) : o) + i)
}
var um = j(0, 0),
  ar = j(1, 22),
  lr = j(2, 22),
...
function Va(e) {
  const t = { color: Ni[ja++ % Ni.length], enabled: xt.enabled(e), namespace: e, log: xt.log, extend: () => {} },
    r = (...n) => {
      const { enabled: i, namespace: o, color: s, log: a } = t
      if ((n.length !== 0 && ur.push([o, ...n]), ur.length > $a && ur.shift(), xt.enabled(o) || i)) {
        const l = n.map((g) => (typeof g == 'string' ? g : Ga(g))),
          f = `+${Date.now() - Fi}ms`
        ;(Fi = Date.now()), a(o, ...l, f)
      }
    }
...
p()
m()
var Pt = { error: ze('prisma:error'), warn: Oi('prisma:warn'), info: Mi('prisma:info'), query: Di('prisma:query') },
...
var Xe = 9e15,
  ...
  yn = { precision: 20, rounding: 4, modulo: 1, toExpNeg: -7, toExpPos: 21, minE: -Xe, maxE: Xe, crypto: !1 },
  so,
  Pe,
  _ = !0,
  wr = '[DecimalError] ',
  ...
  for (
    ...
    if (
      ...
      if (((r = r.slice(s - 3, s + 1)), r == '9999' || (!i && r == '4999'))) {
        ...
        ;(!+r || (!+r.slice(1) && r.charAt(0) == '5')) && (I(n, e + 1, 1), (t = !n.times(n).times(n).eq(this)))
        break
      }
...
C.decimalPlaces = C.dp = function () {
  var e,
    ...
    r = Number.NaN
  if (t) {
    if (((e = t.length - 1), (r = (e - Z(this.e / O)) * O), (e = t[e]), e)) for (; e % 10 == 0; e /= 10) r--
    r < 0 && (r = 0)
  }
  return r
}
...
C.inverseTangent = C.atan = function () {
  ...
  if (f.isFinite()) {
    ...
    if (f.abs().eq(1) && h + 4 <= wn) return (s = fe(g, h + 4, v).times(0.25)), (s.s = f.s), s
  } else {
...
C.logarithm = C.log = function (e) {
  ...
  if (
    ...
    do
      if (((a += 10), (s = ke(this, a)), (n = t ? yr(g, a + 10) : ke(e, a)), (l = q(s, n, a, 1)), !o)) {
...
C.minus = C.sub = function (e) {
  ...
  if (((e = new A(e)), !this.d || !e.d))
    return (
      !this.s || !e.s
        ...
        : this.d
          ? (e.s = -e.s)
          : (e = new A(e.d || this.s !== e.s ? this : Number.NaN)),
      e
    )
  if (this.s != e.s) return (e.s = -e.s), this.plus(e)
  if (((f = this.d), (v = e.d), (a = A.precision), (l = A.rounding), !f[0] || !v[0])) {
    if (v[0]) e.s = -e.s
    else if (f[0]) e = new A(this)
    else return new A(l === 3 ? -0 : 0)
    return _ ? I(e, a, l) : e
  }
  if (((r = Z(e.e / O)), (g = Z(this.e / O)), (f = f.slice()), (o = g - r), o)) {
    for (
      h = o < 0,
  ...
  for (h && ((t = f), (f = v), (v = t), (e.s = -e.s)), s = f.length, n = v.length - s; n > 0; --n) f[s++] = 0
  for (n = v.length; n > o; ) {
    if (f[--n] < v[n]) {
  ...
  while (f[--s] === 0) f.pop()
  for (; f[0] === 0; f.shift()) --r
  return f[0] ? ((e.d = f), (e.e = Er(f, r)), _ ? I(e, a, l) : e) : new A(l === 3 ? -0 : 0)
}
  ...
  return (
    ...
    !this.d || !e.s || (e.d && !e.d[0])
      ...
      : !e.d || (this.d && !this.d[0])
        ...
        : ((_ = !1),
          n.modulo == 9 ? ((t = q(this, e.abs(), 0, 3, 1)), (t.s *= e.s)) : (t = q(this, e, 0, n.modulo, 1)),
          (t = t.times(e)),
          (_ = !0),
          this.minus(t))
  )
...
C.plus = C.add = function (e) {
  ...
  if (((f = this.d), (g = e.d), (a = v.precision), (l = v.rounding), !f[0] || !g[0]))
    return g[0] || (e = new v(this)), _ ? I(e, a, l) : e
  if (((o = Z(this.e / O)), (n = Z(e.e / O)), (f = f.slice()), (i = o - n), i)) {
    for (
...
C.precision = C.sd = function (e) {
  ...
  return this.d ? ((t = po(this.d)), e && this.e + 1 > t && (t = this.e + 1)) : (t = Number.NaN), t
}
C.round = function () {
...
C.squareRoot = C.sqrt = function () {
  var e,
    ...
    f = this.s,
    g = this.constructor
  if (f !== 1 || !a || !a[0]) return new g(!f || (f < 0 && (!a || a[0])) ? Number.NaN : a ? this : 1 / 0)
  for (
    _ = !1,
      f = Math.sqrt(+this),
      f == 0 || f == 1 / 0
    ...
    if (((o = n), (n = o.plus(q(this, o, r + 2, 1)).times(0.5)), K(o.d).slice(0, r) === (t = K(n.d)).slice(0, r)))
      if (((t = t.slice(r - 3, r + 1)), t == '9999' || (!i && t == '4999'))) {
        ...
        ;(!+t || (!+t.slice(1) && t.charAt(0) == '5')) && (I(n, l + 1, 1), (e = !n.times(n).eq(this)))
        break
      }
...
C.times = C.mul = function (e) {
  ...
  if (((e.s *= this.s), !v || !v[0] || !S || !S[0]))
    return new h(!e.s || (v && !v[0] && !S) || (S && !S[0] && !v) ? Number.NaN : !v || !S ? e.s / 0 : e.s * 0)
  for (
...
C.toDecimalPlaces = C.toDP = function (e, t) {
  ...
  return (
    (r = new n(r)),
    e === void 0 ? r : (re(e, 0, Oe), t === void 0 ? (t = n.rounding) : re(t, 0, 8), I(r, e + r.e + 1, t))
  )
}
...
C.toPower = C.pow = function (e) {
  ...
  return (
    (r = J(+a, f)),
    (t = r == 0 || !isFinite(r) ? Z(f * (Math.log('0.' + K(a.d)) / Math.LN10 + a.e + 1)) : new l(r + '').e),
...
var q = (() => {
  ...
  return (n, i, o, s, a, l) => {
    ...
    if (!z || !z[0] || !$ || !$[0])
      return new nr(
        !n.s || !i.s || (z ? $ && z[0] == $[0] : !$) ? Number.NaN : (z && z[0] == 0) || !$ ? Xr * 0 : Xr / 0,
      )
    for (
    ...
    if (
      ($[h] > (z[h] || 0) && g--,
      o == null ? ((G = o = nr.precision), (s = nr.rounding)) : a ? (G = o + (n.e - i.e) + 1) : (G = o),
      G < 0)
    )
      B.push(1), (A = !0)
    else {
          ...
          (v = 0),
            ...
            f < 0
              ? ((ie = k[0]),
                ...
                D < F && R.unshift(0),
                r(k, R, F, l),
                f == -1 && ((F = k.length), (f = t($, k, ue, F)), f < 1 && (v++, r(k, ue < F ? rr : $, F, l))),
                (F = k.length))
              : f === 0 && (v++, (k = [0])),
            (B[h++] = v),
...
function I(e, t, r, n) {
  ...
  e: if (t != null) {
    ...
    if (
      ...
      return (
        (h.length = 0), f ? ((t -= e.e + 1), (h[0] = J(10, (O - (t % O)) % O)), (e.e = -t || 0)) : (h[0] = e.e = 0), e
      )
    if (
      (o == 0
        ? ((h.length = v), (a = 1), v--)
        : ((h.length = v + 1), (a = J(10, O - o)), (h[v] = s > 0 ? (((g / J(10, i - s)) % J(10, s)) | 0) * a : 0)),
      f)
    )
      for (;;)
        if (v == 0) {
...
function En(e, t) {
  ...
  for (t == null ? ((_ = !1), (l = A)) : (l = t), a = new v(0.03125); e.e > -2; ) (e = e.times(a)), (h += 5)
  for (n = ((Math.log(J(2, h)) / Math.LN10) * 2 + 5) | 0, l += n, r = o = s = new v(1), v.precision = l; ; ) {
    if (
      ...
      if (t == null)
        if (f < 3 && Tt(s.d, l - n, S, f)) (v.precision = l += 10), (r = o = a = new v(1)), (g = 0), f++
...
function ke(e, t) {
  ...
  if (R.s < 0 || !D || !D[0] || (!R.e && D[0] == 1 && D.length == 1))
    return new M(D && !D[0] ? -1 / 0 : R.s != 1 ? Number.NaN : D ? 0 : R)
  if (
    (t == null ? ((_ = !1), (g = k)) : (g = t),
    (M.precision = g += A),
    (r = K(D)),
    ...
    while ((n < 7 && n != 1) || (n == 1 && r.charAt(1) > 3)) (R = R.times(e)), (r = K(R.d)), (n = r.charAt(0)), S++
...
function Cl(e, t) {
  ...
  ;(r = 1.4 * Math.sqrt(n)), (r = r > 16 ? 16 : r | 0), (t = t.times(1 / br(5, r))), (t = et(e, 2, t, t))
...
function bn(e, t, r, n) {
  var i,
    ...
    A = r !== void 0
  if (
    (A ? (re(r, 1, Oe), n === void 0 ? (n = S.rounding) : re(n, 0, 8)) : ((r = S.precision), (n = S.rounding)),
    !e.isFinite())
  )
    g = go(e)
  else {
    ...
    if (!h[0]) g = A ? '0p+0' : '0'
      ...
      if (
        (s < 0
          ? o--
          : ((e = new S(e)), (e.d = h), (e.e = o), (e = q(e, v, r, n, 0, i)), (h = e.d), (o = e.e), (f = so)),
        (s = h[r]),
        (a = i / 2),
        (f = f || h[r + 1] !== void 0),
        (f =
...
function yo(e) {
  ...
  function i(o) {
    ...
    if (l === 'bigint') return o < 0 ? ((o = -o), (this.s = -1)) : (this.s = 1), fr(this, o.toString())
    throw Error(Ie + o)
  }
  if (
    ((i.prototype = C),
...
var ve = Be
function Ct(e) {
  return e === null ? e : Array.isArray(e) ? e.map(Ct) : typeof e == 'object' ? (pu(e) ? mu(e) : Ze(e, Ct)) : e
}
function pu(e) {
...
var gu = Qe(Ki())
var hu = { red: ze, gray: _i, dim: lr, bold: ar, underline: ki, highlightSource: (e) => e.highlight() },
  yu = { red: (e) => e, gray: (e) => e, dim: (e) => e, bold: (e) => e, underline: (e) => e, highlightSource: (e) => e }
...
function vr(e) {
  let t = e.showColors ? hu : yu,
    r
  return typeof $getTemplateParameters < 'u' ? (r = $getTemplateParameters(e, t)) : (r = wu(e)), Eu(r, t)
}
d()
u()
c()
...
function xu(e) {
  ...
  for (const n of e) {
    ...
    const i = `${n.selectionPath.join('.')}:${n.argumentPath.join('.')}`,
      o = t.get(i)
    o
      ? t.set(i, { ...n, argument: { ...n.argument, typeNames: Pu(o.argument.typeNames, n.argument.typeNames) } })
      : t.set(i, n)
  }
...
var st = class e extends Me {
  ...
  getDeepField(t) {
    ...
    for (const s of n) {
      let a
      if (
        (o.value instanceof e ? (a = o.value.getField(s)) : o.value instanceof ot && (a = o.value.getField(Number(s))),
        !a)
      )
        return
      o = a
...
function Ru(e, t, r) {
  r.removeAllFields()
  for (const n of e.outputType.fields) r.addSuggestion(new ae(n.name, 'false'))
  t.addErrorMessage(
    (n) =>
...
function ku(e, t) {
  ...
  const n = new ae('omit', r).makeRequired()
  if (e.selectionPath.length === 0) t.arguments.addSuggestion(n)
  else {
    const [i, o] = kt(e.selectionPath),
...
function _u(e, t) {
  ...
  if (a)
    if (((r = a.getField(o)), r && a.removeField(o), e.inputTypes.length === 1 && e.inputTypes[0].kind === 'object')) {
      ...
      const l = e.inputTypes.map(ko).join(' | ')
...
function Io(e, t) {
  for (const r of t.fields) e.hasField(r.name) || e.addSuggestion(new ae(r.name, 'true'))
}
function qu(e, t) {
  for (const r of t.fields) r.isRelation && !e.hasField(r.name) && e.addSuggestion(new ae(r.name, 'true'))
}
function $u(e, t) {
  for (const r of t.fields) !e.hasField(r.name) && !r.isRelation && e.addSuggestion(new ae(r.name, 'true'))
}
function ju(e, t) {
  for (const r of t) e.hasField(r.name) || e.addSuggestion(new ae(r.name, r.typeNames.join(' | ')))
}
function Oo(e, t) {
  const [r, n] = kt(e),
...
function No(e) {
  ...
  if (e instanceof Date) {
    const t = xr(e) ? e.toISOString() : 'Invalid Date'
...
function Dr({ args: e, errors: t, errorFormat: r, callsite: n, originalMethod: i, clientVersion: o, globalOmit: s }) {
  ...
  const { message: l, args: f } = Or(a, r),
    g = vr({ message: l, callsite: n, originalMethod: i, showColors: r === 'pretty', callArguments: f })
...
function Lo(e, t, r) {
  ...
  return !t.result || !(t.result.$allModels || t.result[n])
    ? e
    : Ju({ ...e, ...Fo(t.name, e, t.result.$allModels), ...Fo(t.name, e, t.result[n]) })
}
function Ju(e) {
  const t = new he(),
...
function Yu(e, t, r) {
  const n = {}
  return (
    e.modelOrType && !e.isRawAction() && ((n.$composites = !0), (n.$scalars = !0)), t && Zu(n, t, e), Xu(n, r, e), n
  )
}
function Zu(e, t, r) {
...
function pe(e, t) {
  const r = cc(t),
    ...
    i = new Proxy(e, {
      ...
      ownKeys(o) {
        const s = Yo(Reflect.ownKeys(o), r),
...
function $r({ error: e, user_facing_error: t }, r, n) {
  return t.error_code
    ? new oe(mc(t, n), { code: t.error_code, clientVersion: r, meta: t.meta, batchRequestIdx: t.batch_request_idx })
...
function _e(e) {
  return typeof $EnabledCallSite == 'function' && e !== 'minimal' ? new $EnabledCallSite() : new _n()
}
d()
u()
c()
...
function pt(e = {}) {
  const t = fc(e)
  return Object.entries(t).reduce((n, [i, o]) => (Xo[i] !== void 0 ? (n.select[i] = { select: o }) : (n[i] = o), n), {
    select: {},
  })
}
function fc(e = {}) {
...
var os = (e) => (Array.isArray(e) ? e : e.split('.')),
  ...
  ss = (e, t, r) => os(t).reduceRight((n, i, o, s) => Object.assign({}, Nn(e, s.slice(0, o)), { [i]: n }), r)
function Ec(e, t) {
...
var Pc = ['findUnique', 'findUniqueOrThrow', 'findFirst', 'findFirstOrThrow', 'create', 'update', 'upsert', 'delete'],
  vc = ['aggregate', 'count', 'groupBy']
function Ln(e, t) {
  const r = e._extensions.getAllModelExtensions(t) ?? {},
    n = [Tc(e, t), Ac(e, t), qt(r), ee('name', () => t), ee('$name', () => t), ee('$parent', () => e._appliedParent)]
  return pe({}, n)
}
function Tc(e, t) {
  const r = we(t),
...
var Bn = Symbol()
function $t(e) {
  const t = [Rc(e), Sc(e), ee(Bn, () => e), ee('$parent', () => e._appliedParent)],
...
function Vr({ visitor: e, result: t, args: r, runtimeDataModel: n, modelName: i }) {
  ...
  const o = e(t, i, r) ?? t
  return (
    r.include && ps({ includeOrSelect: r.include, result: o, parentModelName: i, runtimeDataModel: n, visitor: e }),
    r.select && ps({ includeOrSelect: r.select, result: o, parentModelName: i, runtimeDataModel: n, visitor: e }),
    o
  )
}
function ps({ includeOrSelect: e, result: t, parentModelName: r, runtimeDataModel: n, visitor: i }) {
  for (const [o, s] of Object.entries(e)) {
    ...
    t[o] = Vr({ visitor: i, result: t[o], args: f, modelName: l.type, runtimeDataModel: n })
  }
}
function ms({ result: e, modelName: t, args: r, extensions: n, runtimeDataModel: i, globalOmit: o }) {
...
function Un() {
  const e = qc()
  return { id: e, prettyName: $c[e] || e, isEdge: ['workerd', 'deno', 'netlify', 'edge-light'].includes(e) }
}
d()
u()
c()
...
async function Xt(e, t) {
  ...
  const r = { clientVersion: t, response: e },
    n = await Gc(e)
  if (n.type === 'QueryEngineError') throw new oe(n.body.message, { code: n.body.error_code, clientVersion: t })
...
async function Hc(e, t) {
  const r = Ss['@prisma/engines-version'],
  ...
  ht = class {
    ...
    async uploadSchema() {
      ...
      return this.tracingHelper.runInChildSpan(t, async () => {
        const r = await Ve(await this.url('schema'), {
          method: 'PUT',
    ...
    requestInternal({ body: t, traceparent: r, customDataProxyFetch: n, interactiveTransaction: i }) {
      return this.withRetry({
        ...
        callback: async ({ logHttpCall: o }) => {
          ...
          a.ok || Qr('graphql response status', a.status), await this.handleError(await Xt(a, this.clientVersion))
    ...
    async handleError(t) {
      if (t instanceof je) throw (await this.uploadSchema(), new dt({ clientVersion: this.clientVersion, cause: t }))
      if (t) throw t
    }
...
function Ds({ copyEngine: e = !0 }, t) {
  ...
  const n = !!(r?.startsWith('prisma://') || mn(r))
  e &&
    n &&
    mr(
      'recommend--no-engine',
...
function Bs(e) {
  ...
  const t = {}
  for (const r of Object.keys(e)) t[r] = Fs(e[r])
  return t
}
function Fs(e) {
    ...
    (r) => {
      ...
      if (Fr(r)) (n = r.sql), (i = { values: yt(r.values), __prismaRawParameters__: !0 })
        ...
        switch (t) {
          ...
          case 'sqlserver': {
            ;(n = _s(r)), (i = { values: yt(r.values), __prismaRawParameters__: !0 })
            break
          }
          default:
            throw new Error(`The ${t} provider does not support ${e}`)
        }
      return i?.values ? Us(`prisma.${e}(${n}, ${i.values})`) : Us(`prisma.${e}(${n})`), { query: n, parameters: i }
    },
  qs = {
...
function zn(e) {
  return (r, n) => {
    let i,
      o = (s = e) => {
        try {
          return s === void 0 || s?.kind === 'itx' ? (i ??= js(r(s))) : js(r(s))
        } catch (a) {
...
var Zc = pn.split('.')[0],
  ...
  Yn = class {
    ...
    getGlobalTracingHelper() {
      const t = globalThis[`V${Zc}_PRISMA_INSTRUMENTATION`],
      ...
      ;(this.logEmitter = r),
        ...
        (this.dataloader = new Kr({
          ...
          singleLoader: async (n) => {
            const i = n.transaction?.kind === 'itx' ? Hs(n.transaction) : void 0,
          ...
          batchBy: (n) => (n.transaction?.id ? `transaction-${n.transaction.id}` : Js(n.protocolQuery)),
          batchOrder(n, i) {
...
It should have this form: { url: "CONNECTION_STRING" }`)
    ...
    adapter: (e, t) => {
      if (!e && Ye(t.generator) === 'client')
        throw new U('Using engine type "client" requires a driver adapter to be provided to PrismaClient constructor.')
      if (e === null) return
      if (e === void 0)
...
Expected string or undefined.`)
    ...
    omit: (e, t) => {
      ...
      for (const [n, i] of Object.entries(e)) {
        const o = up(n, t.runtimeDataModel)
        if (!o) {
...
function lp(e, t) {
  ...
  const r = t.map((i) => ({ value: i, distance: (0, ra.default)(e, i) }))
...
function cp(e, t) {
  ...
  const { message: n, args: i } = Or(r, 'colorless')
  ...
  class t {
    ...
    constructor(n) {
      ...
      let o = e.relativeEnvPaths && {
          rootEnvPath: e.relativeEnvPaths.rootEnvPath && cr.resolve(e.dirname, e.relativeEnvPaths.rootEnvPath),
          schemaEnvPath: e.relativeEnvPaths.schemaEnvPath && cr.resolve(e.dirname, e.relativeEnvPaths.schemaEnvPath),
        },
        s
      if (n?.adapter) {
        s = n.adapter
      ...
      try {
        ...
        Ui.existsSync(h) || (h = e.dirname), Ne('dirname', e.dirname), Ne('relativePath', e.relativePath), Ne('cwd', h)
        const v = f.engine || {}
        if (
          (l.errorFormat
          ...
          for (const S of l.log) {
            const A = typeof S == 'string' ? S : S.emit === 'stdout' ? S.level : null
            A &&
              this.$on(A, (R) => {
    ...
    $runCommandRaw(n) {
      if (e.activeProvider !== 'mongodb')
        throw new X(`The ${e.activeProvider} provider does not support $runCommandRaw. Use the mongodb provider.`, {
          clientVersion: this._clientVersion,
        })
    ...
    $queryRaw(n, ...i) {
      return this._createPrismaPromise((o) => {
        if (n.raw !== void 0 || n.sql !== void 0) return this.$queryRawInternal(o, '$queryRaw', ...oa(n, i))
        throw new X(
    ...
    _request(n) {
      ...
      let i = n.middlewareArgsMapper ?? pp,
        ...
        l = async (f) => {
          ...
          if (g) return this._tracingHelper.runInChildSpan(s.middleware, (D) => g(f, (M) => (D?.end(), l(M))))
          const { runInTransaction: h, args: v, ...S } = f,
            A = { ...n, ...S }
          v && (A.args = i.middlewareArgsToRequestArgs(v)), n.transaction !== void 0 && h === !1 && delete A.transaction
          const R = await ys(this, A)
          return A.model
            ? ms({
                result: R,
                modelName: A.model,
