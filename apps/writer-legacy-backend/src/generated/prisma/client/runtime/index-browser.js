...
var Xe = (e, n, i) => (n in e ? ne(e, n, { enumerable: !0, configurable: !0, writable: !0, value: i }) : (e[n] = i))
var Ce = (e, n) => {
  ...
  Ke = (e, n, i, t) => {
    if ((n && typeof n == 'object') || typeof n == 'function')
      for (const r of Ge(n))
        !Je.call(e, r) && r !== i && ne(e, r, { get: () => n[r], enumerable: !(t = We(n, r)) || t.enumerable })
    return e
  }
...
var V = 9e15,
  ...
  Ee = { precision: 20, rounding: 4, modulo: 1, toExpNeg: -7, toExpPos: 21, minE: -V, maxE: V, crypto: !1 },
  Te,
  Z,
  w = !0,
  ce = '[DecimalError] ',
...
h.comparedTo = h.cmp = function (e) {
  var n,
    ...
    c = this.s,
    f = e.s
  if (!o || !u) return !c || !f ? Number.NaN : c !== f ? c : o === u ? 0 : !o ^ (c < 0) ? 1 : -1
  ...
  for (
    ...
    if (
      ...
      if (((i = i.slice(o - 3, o + 1)), i == '9999' || (!r && i == '4999'))) {
        ...
        ;(!+i || (!+i.slice(1) && i.charAt(0) == '5')) && (p(t, e + 1, 1), (n = !t.times(t).times(t).eq(this)))
        break
      }
...
h.logarithm = h.log = function (e) {
  ...
  if (e == null) (e = new l(10)), (n = !0)
    ...
    if (((e = new l(e)), (i = e.d), e.s < 0 || !i || !i[0] || e.eq(1))) return new l(Number.NaN)
    n = e.eq(10)
  }
  if (((i = this.d), this.s < 0 || !i || !i[0] || this.eq(1)))
    return new l(i && !i[0] ? -1 / 0 : this.s != 1 ? Number.NaN : i ? 0 : 1 / 0)
  if (n)
    if (i.length > 1) s = !0
    else {
  ...
  if (
    ...
    do
      if (((u += 10), (o = B(this, u)), (t = n ? fe(l, u + 10) : B(e, u)), (c = k(o, t, u, 1)), !s)) {
  ...
  return (
    ...
    !this.d || !e.s || (e.d && !e.d[0])
      ...
      : !e.d || (this.d && !this.d[0])
        ...
        : ((w = !1),
          t.modulo == 9 ? ((n = k(this, e.abs(), 0, 3, 1)), (n.s *= e.s)) : (n = k(this, e, 0, t.modulo, 1)),
          (n = n.times(e)),
          (w = !0),
          this.minus(n))
  )
...
h.precision = h.sd = function (e) {
  ...
  return this.d ? ((n = Ze(this.d)), e && this.e + 1 > n && (n = this.e + 1)) : (n = Number.NaN), n
}
h.round = function () {
...
h.squareRoot = h.sqrt = function () {
  var e,
    ...
    f = this.s,
    l = this.constructor
  if (f !== 1 || !u || !u[0]) return new l(!f || (f < 0 && (!u || u[0])) ? Number.NaN : u ? this : 1 / 0)
  for (
    w = !1,
      f = Math.sqrt(+this),
      f == 0 || f == 1 / 0
    ...
    if (((s = t), (t = s.plus(k(this, s, i + 2, 1)).times(0.5)), b(s.d).slice(0, i) === (n = b(t.d)).slice(0, i)))
      if (((n = n.slice(i - 3, i + 1)), n == '9999' || (!r && n == '4999'))) {
        ...
        ;(!+n || (!+n.slice(1) && n.charAt(0) == '5')) && (p(t, c + 1, 1), (e = !t.times(t).eq(this)))
        break
      }
...
h.times = h.mul = function (e) {
  ...
  if (((e.s *= this.s), !d || !d[0] || !g || !g[0]))
    return new a(!e.s || (d && !d[0] && !g) || (g && !g[0] && !d) ? Number.NaN : !d || !g ? e.s / 0 : e.s * 0)
  for (
...
h.toDecimalPlaces = h.toDP = function (e, n) {
  var i = this,
    t = i.constructor
  return (
    (i = new t(i)), e === void 0 ? i : (q(e, 0, H), n === void 0 ? (n = t.rounding) : q(n, 0, 8), p(i, e + i.e + 1, n))
  )
}
h.toExponential = function (e, n) {
  ...
  return (
    e === void 0
      ? (i = L(t, !0))
      : (q(e, 0, H), n === void 0 ? (n = r.rounding) : q(n, 0, 8), (t = p(new r(t), e + 1, n)), (i = L(t, !0, e + 1))),
...
h.toSignificantDigits = h.toSD = function (e, n) {
  ...
  return (
    e === void 0 ? ((e = t.precision), (n = t.rounding)) : (q(e, 1, H), n === void 0 ? (n = t.rounding) : q(n, 0, 8)),
    p(new t(this), e, n)
  )
}
h.toString = function () {
  ...
  return (
    ...
    t == null
      ? n < 3
        ...
        : (o =
            (((i < 4 && u + 1 == s) || (i > 3 && u + 1 == s / 2)) && ((e[r + 1] / s / 100) | 0) == C(10, n - 2) - 1) ||
...
var k = (() => {
  ...
  return (t, r, s, o, u, c) => {
    ...
    if (!O || !O[0] || !S || !S[0])
      return new ee(
        !t.s || !r.s || (O ? S && O[0] == S[0] : !S) ? Number.NaN : (O && O[0] == 0) || !S ? pe * 0 : pe / 0,
      )
    for (
          ...
          (d = 0),
            ...
            f < 0
              ? ((x = E[0]),
                ...
                A < P && N.unshift(0),
                i(E, N, P, c),
                f == -1 && ((P = E.length), (f = n(S, E, T, P)), f < 1 && (d++, i(E, T < P ? y : S, P, c))),
                (P = E.length))
              : f === 0 && (d++, (E = [0])),
            (_[a++] = d),
...
function p(e, n, i, t) {
  ...
  e: if (n != null) {
    ...
    if (
      ...
      return (
        (a.length = 0), f ? ((n -= e.e + 1), (a[0] = C(10, (m - (n % m)) % m)), (e.e = -n || 0)) : (a[0] = e.e = 0), e
      )
    if (
      (s == 0
        ? ((a.length = d), (u = 1), d--)
        : ((a.length = d + 1), (u = C(10, m - s)), (a[d] = o > 0 ? (((l / C(10, r - o)) % C(10, o)) | 0) * u : 0)),
      f)
    )
      for (;;)
        if (d == 0) {
...
function B(e, n) {
  ...
  if (
    ...
    while ((t < 7 && t != 1) || (t == 1 && i.charAt(1) > 3)) (N = N.times(e)), (i = b(N.d)), (t = i.charAt(0)), g++
...
function dn(e, n) {
  ...
  } else if (n === 'Infinity' || n === 'NaN') return +n || (e.s = Number.NaN), (e.e = Number.NaN), (e.d = null), e
  ...
  if (
    ...
    for (
      l = L(e),
        ...
        o >= 0 &&
          ((l = l.replace('.', '')), (d = new g(1)), (d.e = l.length - o), (d.d = re(L(d), 10, r)), (d.e = d.d.length)),
        a = re(l, 10, r),
        s = c = a.length;
      a[--c] == 0;
    )
    ...
    if (!a[0]) l = v ? '0p+0' : '0'
      ...
      if (
        (o < 0
          ? s--
          : ((e = new g(e)), (e.d = a), (e.e = s), (e = k(e, d, i, t, 0, r)), (a = e.d), (s = e.e), (f = Te)),
        (o = a[i]),
        (u = r / 2),
        (f = f || a[i + 1] !== void 0),
        (f =
...
function Ve(e) {
  ...
  function r(s) {
    ...
    if (c === 'string')
      return (
        (u = s.charCodeAt(0)) === 45 ? ((s = s.slice(1)), (this.s = -1)) : (u === 43 && (s = s.slice(1)), (this.s = 1)),
        Ie.test(s) ? se(this, s) : dn(this, s)
      )
    if (c === 'bigint') return s < 0 ? ((s = -s), (this.s = -1)) : (this.s = 1), se(this, s.toString())
    throw Error($ + s)
  }
  if (
    ((r.prototype = h),
