...
const testMessage = {
  ...
  role: 'assistant',
  content:
    'Alice walked into the mysterious forest where strange shadows danced between the ancient trees. She felt the weight of destiny upon her shoulders as she searched for the lost artifact.',
  timestamp: new Date(),
  isQuery: false,
}
...
const _mockGenerate = async (prompt) => {
