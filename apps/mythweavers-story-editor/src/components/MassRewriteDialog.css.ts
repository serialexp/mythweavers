...
export const messageItemSelected = style([
  messageItem,
  {
...
export const messageItemProcessed = style([
  messageItem,
  {
...
export const messageItemPending = style([
  messageItem,
  {
...
export const messageCheckbox = style({
  flexShrink: 0,
})

export const messageIndex = style({
  fontWeight: 600,
  fontSize: '0.75rem',
...
export const processingHeader = style({
  display: 'flex',
  alignItems: 'center',
  justifyContent: 'space-between',
  padding: '0.75rem',
