...
export const pendingEntitiesStore = {
  // Getters
  get batches() {
    return pendingEntitiesState.batches
  },
  get isVisible() {
    return pendingEntitiesState.isVisible
  },
  get hasPendingEntities() {
    return pendingEntitiesState.batches.length > 0
  },
