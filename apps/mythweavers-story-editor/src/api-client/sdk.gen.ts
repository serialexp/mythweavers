 ...
 */
export const postOauthRegister = <ThrowOnError extends boolean = false>(options: Options<PostOauthRegisterData, ThrowOnError>) => (options.client ?? client).post<PostOauthRegisterResponses, PostOauthRegisterErrors, ThrowOnError>({
    url: '/oauth/register',
    ...options,
    headers: {
        'Content-Type': 'application/json',
...
/**
 * Authorization endpoint. Redirects the browser to the consent screen.
 */
...
/**
 * Details of a pending authorization request, for the consent screen
 */
export const getOauthConsentByRequestId = <ThrowOnError extends boolean = false>(options: Options<GetOauthConsentByRequestIdData, ThrowOnError>) => (options.client ?? client).get<GetOauthConsentByRequestIdResponses, GetOauthConsentByRequestIdErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionToken',
            type: 'apiKey'
 ...
 */
export const postOauthConsentByRequestId = <ThrowOnError extends boolean = false>(options: Options<PostOauthConsentByRequestIdData, ThrowOnError>) => (options.client ?? client).post<PostOauthConsentByRequestIdResponses, PostOauthConsentByRequestIdErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionToken',
            type: 'apiKey'
 ...
 * Authorization endpoint. Redirects the browser to the consent screen.
 */
export const getAuthorize = <ThrowOnError extends boolean = false>(options?: Options<GetAuthorizeData, ThrowOnError>) => (options?.client ?? client).get<unknown, GetAuthorizeErrors, ThrowOnError>({ url: '/authorize', ...options });

/**
 * Revoke an access or refresh token (RFC 7009)
 */
export const postRevoke = <ThrowOnError extends boolean = false>(options: Options<PostRevokeData, ThrowOnError>) => (options.client ?? client).post<PostRevokeResponses, PostRevokeErrors, ThrowOnError>({
    url: '/revoke',
    ...options,
    headers: {
        'Content-Type': 'application/json',
 ...
 * Exchange device code for access token (poll until authorized)
 */
export const postToken = <ThrowOnError extends boolean = false>(options: Options<PostTokenData, ThrowOnError>) => (options.client ?? client).post<PostTokenResponses, PostTokenErrors, ThrowOnError>({
    url: '/token',
    ...options,
    headers: {
        'Content-Type': 'application/json',
...
/**
 * List apps connected to your account, and any standalone access tokens
 */
export const getMyAccessTokens = <ThrowOnError extends boolean = false>(options?: Options<GetMyAccessTokensData, ThrowOnError>) => (options?.client ?? client).get<GetMyAccessTokensResponses, GetMyAccessTokensErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionToken',
            type: 'apiKey'
...
/**
 * Revoke a connected app or a standalone access token
 */
export const deleteMyAccessTokensById = <ThrowOnError extends boolean = false>(options: Options<DeleteMyAccessTokensByIdData, ThrowOnError>) => (options.client ?? client).delete<DeleteMyAccessTokensByIdResponses, DeleteMyAccessTokensByIdErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionToken',
            type: 'apiKey'
 ...
 */
export const getMyStoriesByIdLoadStory = <ThrowOnError extends boolean = false>(options: Options<GetMyStoriesByIdLoadStoryData, ThrowOnError>) => (options.client ?? client).get<GetMyStoriesByIdLoadStoryResponses, GetMyStoriesByIdLoadStoryErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionToken',
            type: 'apiKey'
...
/**
 * Create a book, arc, chapter or scene. The kind is derived from the parent: story→book, book→arc, arc→chapter, chapter→scene. Fields that do not apply to the derived kind are rejected by name.
 */
export const postMyNodes = <ThrowOnError extends boolean = false>(options: Options<PostMyNodesData, ThrowOnError>) => (options.client ?? client).post<PostMyNodesResponses, PostMyNodesErrors, ThrowOnError>({
    url: '/my/nodes',
    ...options,
    headers: {
        'Content-Type': 'application/json',
 ...
 */
export const patchMyNodesById = <ThrowOnError extends boolean = false>(options: Options<PatchMyNodesByIdData, ThrowOnError>) => (options.client ?? client).patch<PatchMyNodesByIdResponses, PatchMyNodesByIdErrors, ThrowOnError>({
    url: '/my/nodes/{id}',
    ...options,
    headers: {
        'Content-Type': 'application/json',
 ...
 */
export const postMyNodesByIdMove = <ThrowOnError extends boolean = false>(options: Options<PostMyNodesByIdMoveData, ThrowOnError>) => (options.client ?? client).post<PostMyNodesByIdMoveResponses, PostMyNodesByIdMoveErrors, ThrowOnError>({
...
/**
 * Read the prose under a node in one request, with paragraph IDs attached so the result can be edited directly. Refuses with 413 and a per-chapter breakdown when the subtree exceeds maxWords.
 */
export const getMyNodesByIdContent = <ThrowOnError extends boolean = false>(options: Options<GetMyNodesByIdContentData, ThrowOnError>) => (options.client ?? client).get<GetMyNodesByIdContentResponses, GetMyNodesByIdContentErrors, ThrowOnError>({ url: '/my/nodes/{id}/content', ...options });

/**
 * Structural outline of a story, without prose. Four flat queries regardless of story size — use this to navigate before reading content.
 */
export const getMyStoriesByStoryIdOutline = <ThrowOnError extends boolean = false>(options: Options<GetMyStoriesByStoryIdOutlineData, ThrowOnError>) => (options.client ?? client).get<GetMyStoriesByStoryIdOutlineResponses, GetMyStoriesByStoryIdOutlineErrors, ThrowOnError>({ url: '/my/stories/{storyId}/outline', ...options });

/**
 * Case-insensitive substring search across prose, characters, context items and node summaries. Only current paragraph revisions are searched.
 */
export const getMyStoriesByStoryIdSearch = <ThrowOnError extends boolean = false>(options: Options<GetMyStoriesByStoryIdSearchData, ThrowOnError>) => (options.client ?? client).get<GetMyStoriesByStoryIdSearchResponses, GetMyStoriesByStoryIdSearchErrors, ThrowOnError>({ url: '/my/stories/{storyId}/search', ...options });

/**
 * Apply a batch of paragraph edits transactionally. Every write creates a new ParagraphRevision, so edits are reversible from revision history.
 */
export const postMyProseEdits = <ThrowOnError extends boolean = false>(options: Options<PostMyProseEditsData, ThrowOnError>) => (options.client ?? client).post<PostMyProseEditsResponses, PostMyProseEditsErrors, ThrowOnError>({
    url: '/my/prose/edits',
    ...options,
    headers: {
        'Content-Type': 'application/json',
...
/**
 * Get file content. Public files are accessible anonymously; private files require an authenticated owner.
 */
 ...
 */
export const getMyImagesModels = <ThrowOnError extends boolean = false>(options?: Options<GetMyImagesModelsData, ThrowOnError>) => (options?.client ?? client).get<GetMyImagesModelsResponses, GetMyImagesModelsErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionToken',
            type: 'apiKey'
...
/**
 * Generate an image from a text prompt and store it as a File owned by the user. Synchronous — the response includes the resulting fileId once generation completes.
 */
export const postMyImagesGenerate = <ThrowOnError extends boolean = false>(options: Options<PostMyImagesGenerateData, ThrowOnError>) => (options.client ?? client).post<PostMyImagesGenerateResponses, PostMyImagesGenerateErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionToken',
            type: 'apiKey'
...
/**
 * List all movements for a pawn
 */
export const getMyPawnsByPawnIdMovements = <ThrowOnError extends boolean = false>(options: Options<GetMyPawnsByPawnIdMovementsData, ThrowOnError>) => (options.client ?? client).get<GetMyPawnsByPawnIdMovementsResponses, GetMyPawnsByPawnIdMovementsErrors, ThrowOnError>({ url: '/my/pawns/{pawnId}/movements', ...options });

/**
 * Create a movement for a pawn
 */
export const postMyPawnsByPawnIdMovements = <ThrowOnError extends boolean = false>(options: Options<PostMyPawnsByPawnIdMovementsData, ThrowOnError>) => (options.client ?? client).post<PostMyPawnsByPawnIdMovementsResponses, PostMyPawnsByPawnIdMovementsErrors, ThrowOnError>({
...
/**
 * List all pawn movements on a map
 */
export const getMyMapsByMapIdPawnMovements = <ThrowOnError extends boolean = false>(options: Options<GetMyMapsByMapIdPawnMovementsData, ThrowOnError>) => (options.client ?? client).get<GetMyMapsByMapIdPawnMovementsResponses, GetMyMapsByMapIdPawnMovementsErrors, ThrowOnError>({ url: '/my/maps/{mapId}/pawn-movements', ...options });

/**
 * Delete a pawn movement
 */
export const deleteMyPawnMovementsById = <ThrowOnError extends boolean = false>(options: Options<DeleteMyPawnMovementsByIdData, ThrowOnError>) => (options.client ?? client).delete<DeleteMyPawnMovementsByIdResponses, DeleteMyPawnMovementsByIdErrors, ThrowOnError>({ url: '/my/pawn-movements/{id}', ...options });

/**
 * Get a single pawn movement by ID
 */
export const getMyPawnMovementsById = <ThrowOnError extends boolean = false>(options: Options<GetMyPawnMovementsByIdData, ThrowOnError>) => (options.client ?? client).get<GetMyPawnMovementsByIdResponses, GetMyPawnMovementsByIdErrors, ThrowOnError>({ url: '/my/pawn-movements/{id}', ...options });

/**
 * Update a pawn movement
 */
export const putMyPawnMovementsById = <ThrowOnError extends boolean = false>(options: Options<PutMyPawnMovementsByIdData, ThrowOnError>) => (options.client ?? client).put<PutMyPawnMovementsByIdResponses, PutMyPawnMovementsByIdErrors, ThrowOnError>({
...
/**
 * Replace all segments of a path in one request
 */
export const putMyPathsByPathIdSegments = <ThrowOnError extends boolean = false>(options: Options<PutMyPathsByPathIdSegmentsData, ThrowOnError>) => (options.client ?? client).put<PutMyPathsByPathIdSegmentsResponses, PutMyPathsByPathIdSegmentsErrors, ThrowOnError>({
    url: '/my/paths/{pathId}/segments',
    ...options,
    headers: {
        'Content-Type': 'application/json',
