...
export async function searchLandmarkInfo(
  landmarkName: string,
  landmarkType?: 'system' | 'station' | 'nebula' | 'junction',
  ...
  try {
    console.log(
      `[LandmarkSearch] Searching for information about: ${landmarkName} (type: ${landmarkType || 'unknown'})`,
    )
